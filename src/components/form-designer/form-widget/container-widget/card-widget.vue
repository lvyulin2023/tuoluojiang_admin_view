<template>
  <container-wrapper
    ...
    :style="{ marginTop: widget.options.topMargin + 20 + 'px !important' || '', marginBottom: widget.options.bottomMargin + 'px !important' || ''}"
  >
    <el-card
      :key="widget.id"
    ...
    >
      <div slot="header" class="header clear-fix pointer" v-if="widget.options.cardHeader" @click="toggleCard">

...
<template>
  <div class="divBox">
                ...
                <div class="mt14">
                  <el-table :data="tableData" :height="tableHeight" style="width: 100%" row-key="id" default-expand-all>
                    ...
                    <el-table-column prop="title" label="标题" min-width="150" show-overflow-tooltip>
                      <template slot-scope="scope">
                        <div class="over-text2">{{ scope.row.title }}</div>
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="is_top" label="置顶" min-width="80">
                      <template slot-scope="scope">
                        <el-switch
                          class="is-top"
    ...
    <!-- 新建公告页面 -->
    <add-notice v-if="!isCheck" ref="addNotice" :form-data="noticeData" @isNotice="isNotice"></add-notice>
  </div>
</template>

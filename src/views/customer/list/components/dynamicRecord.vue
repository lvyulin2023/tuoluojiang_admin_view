          ...
          <div v-else>
            <div v-if="editIndex !== index">
              ...
              <div v-for="(fileItem, g) in activity.attachs" :key="g" class="flex">
                <div class="fileItem">
                  <img v-if="toSrc(fileItem.name) === 1" alt="" class="img" src="../../../../assets/images/doc.png" />
                  <img v-if="toSrc(fileItem.name) === 2" alt="" class="img" src="../../../../assets/images/ppt.png" />
                  <img v-if="toSrc(fileItem.name) === 3" alt="" class="img" src="../../../../assets/images/xls.png" />
                  <img v-if="toSrc(fileItem.name) === 5" alt="" class="img" src="../../../../assets/images/pdf.png" />
                  <img
...
<script>
import { clientFollowDeleteApi, clientRecordApi } from '@/api/enterprise'

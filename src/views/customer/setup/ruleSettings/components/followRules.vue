      ...
      <el-card :body-style="{ padding: '20px 20px 0' }" class="box-card">
        <div class="setting-container">
          <el-row>
            ...
            <el-col v-bind="grid2">
              <el-form ref="elForm" :model="formData" :rules="rules" label-width="200px" size="medium">
                <div class="card-list">
                  <div class="head">
...
export default {
  ...
  methods: {
    ...
    getVal(type) {
      return (
        typeof this.formData.follow_up_status != 'undefined' && this.formData.follow_up_status.includes(type.toString())
      )
    }
  }
}

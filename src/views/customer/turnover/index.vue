          ...
          <div class="table-box mt14 v-height-flag">
            <div style="height: 838px">
              ...
              >
                ...
                <el-table-column :label="$t('toptable.department')" min-width="80" prop="frame_name" />
...
export default {
  ...
  methods: {
    ...
    confirmData(data) {
      ...
      //   this.where.category_id = this.where.category_id.forEach((value, index) => {
      //     this.where.category_id = '[' + value.join(',') + ']'
      //   })
      // }
    ...
    getTableData(id) {
      ...
      //     data.category_id[index] = '[' + item.join(',') + ']'
      //   })
      salesmanDataListApi(this.where).then((res) => {

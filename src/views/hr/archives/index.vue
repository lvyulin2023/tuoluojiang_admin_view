      ...
      if (newData.length <= 0) {
        ...
        for (let i = 0; i <= newData.length - 1; i++) {
          if (newData[i][0] === '') {
            ...
            if (newData[i][5] == '正式') {
              newData[i][5] = 1
            } else if (newData[i][5] == '试用') {
              newData[i][5] = 2
            } else if (newData[i][5] == '实习') {
              newData[i][5] = 3
            } else if (newData[i][5] == '离职') {
              newData[i][5] = 4
            }

            if (newData[i][4] == '兼职') {
              newData[i][4] = 1
            } else if (newData[i][4] == '全职') {
              newData[i][4] = 0
            } else if (newData[i][4] == '实习') {
              newData[i][4] = 2
            } else if (newData[i][4] == '劳务派遣') {
              newData[i][4] = 3
            } else if (newData[i][4] == '退休返聘') {
              newData[i][4] = 4
            } else if (newData[i][4] == '劳务外包') {
              newData[i][4] = 5
            } else if (newData[i][4] == '其他') {
              newData[i][4] = 6
            } else {
              newData[i][4] = 0
            }
            ...
            if (newData[i][2] == '研究生') {
              newData[i][2] = 6
            } else if (newData[i][2] == '本科') {
              newData[i][2] = 5
            } else if (newData[i][2] == '专科') {
              newData[i][2] = 4
            } else if (newData[i][2] == '高中及以下') {
              newData[i][2] = 2
            }
            res.push({
              name: newData[i][0],
              sex: newData[i][1],
              education: newData[i][2],
              phone: newData[i][3],
              is_part: newData[i][4],
              type: newData[i][5],
              position: '',
        ...
        await importCardApi(data)
        await this.$refs.dynamic.getList()
      }
    },

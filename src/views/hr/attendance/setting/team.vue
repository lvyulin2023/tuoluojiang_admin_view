      ...
      <div class="table-box mt10">
        <el-table :data="tableData" :height="tableHeight" style="width: 100%">
          ...
          <el-table-column fixed="right" label="操作" width="130">
            <template slot-scope="scope">
              <el-button v-hasPermi="['hr:attendance:team:edit']" type="text" @click="editFn(scope.row)"
                >编辑</el-button
              >

              <el-button v-hasPermi="['hr:attendance:team:delete']" type="text" @click="deleteFn(scope.row)"
                >删除</el-button
              >
            </template>
          </el-table-column>

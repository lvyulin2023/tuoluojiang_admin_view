      ...
      <div class="process-left">
        <div class="process-left-con">
          <div v-for="(item, index) in tableData" :key="index" class="process-left-list">
            ...
            <div v-if="index != tableData.length - 1" class="process-icon"><i class="el-icon-d-arrow-left" /></div>
          </div>
        </div>
      </div>
        ...
        <el-col>
          ...
          >
            ...
            <div v-if="item.id == 5" class="process-right-con">
              ...
              <div class="right">
                <template>
                  <el-checkbox :checked="true" :disabled="true" @change="changeSuperior($event)">高级领导</el-checkbox>
                </template>
              </div>
            </div>

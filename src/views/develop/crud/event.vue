  ...
  methods: {
    ...
    OpenSettings(type) {
      ...
      if (type === 'additional_search') {
        boolean = this.form.additional_search_boolean + '' || '0'
      } else if (type === 'aggregate_data_search') {
        boolean = this.form.aggregate_data_search_boolean + '' || '0'
      } else if (type === 'aggregate_target_search') {
        boolean = this.form.aggregate_target_search_boolean + '' || '0'
      } else if (type === 'testOptions') {
        boolean = this.form.options ? this.form.options.search_boolean + '' : '0'
      }

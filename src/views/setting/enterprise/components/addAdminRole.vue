    ...
    >
      <div v-if="drawer" class="container v-height-flag">
        ...
        <div v-show="tabIndex == 2" class="table-box">
          ...
          <el-table v-loading="loading" :key="itemKey" :data="searchList" style="width: 100%">
            <el-table-column prop="table_name" label="实体名称" min-width="120"> </el-table-column>
            <el-table-column label="查看权限" width="300">
            ...
            <el-table-column label="新增权限" width="110">
              <template slot-scope="scope">
            ...
            <el-table-column prop="date" label="修改权限" width="280">
              <template slot-scope="scope">
                <div class="flex">
            ...
            <el-table-column prop="date" label="删除权限" min-width="280">
              <template slot-scope="scope">
                <div class="flex">
                  ...
                  <select-department
                    ...
                    :placeholder="`请选择`"
                    :is-search="true"
                    @changeMastart="changeMastart($event, 'deleted_frames', scope.row, scope.$index)"
                    style="width: 100%"
                  ></select-department>
                </div>
              </template>

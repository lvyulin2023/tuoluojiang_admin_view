        ...
        <el-col v-bind="gridr" class="assess-right">
          <div class="ml14 mr14">
            <div class="clearfix el-card__header">
              ...
              <!-- <el-row>
                <el-col :span="3">
                  <el-button type="primary" size="small" @click="handleNews" v-hasPermi="['system:quick:add']"
                    >新建入口</el-button
                  >
                </el-col>
                <el-col :span="21" class="right-con">
                  <el-form label-width="110px">
                    <el-col>
                      <el-form-item :label="$t('public.search') + '：'" class="select-bar">
                        <el-input
                          v-model="where.name"
                          placeholder="请输入标题"
                          size="small"
                          ...
                          style="width: 100%;"
                          @keyup.native.stop.prevent.enter="handleSearch"
                        >
                          <el-button
                            type="primary"
                            slot="append"

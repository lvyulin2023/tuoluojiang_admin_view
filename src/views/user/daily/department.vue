<template>
  <!-- 部门汇报页面 -->
  <div class="divBox">
    <el-card class="employees-card-bottom card-box" style="padding-top: 0px">
      ...
      <div v-if="activeVal == '3'" class="card-box">
        <oaFromBox
          :isAddBtn="false"
          :isViewSearch="false"
          :search="search"
      ...
      <el-row v-if="activeVal == '4'" class="flexBox">
        <el-col :span="14" class="left">
          ...
          <el-table ref="elTable" :data="table">
            ...
            <el-table-column v-if="submitType == '1'" label="操作" prop="" width="80">
              <template slot-scope="scope">
                <el-button type="text" @click="onEdit(scope.row.daily_id, true, scope.row)">
                  {{ $t('public.check') }}
                </el-button>
              </template>
            </el-table-column>
      ...
      <div v-if="activeVal == '5'">
        ...
        <!-- 抄送我的列表 -->
        <div v-loading="loading" class="mt-10">
          <!-- <div class="inTotal">共有 {{ totalPage }} 条</div> -->
          <el-table ref="elTable" :data="tableData" :height="tableHeight">
            <el-table-column :label="$t('toptable.name')" prop="name" width="90" />
            <el-table-column :label="$t('toptable.department')" min-width="100" prop="frame_name" />
            <el-table-column :label="$t('toptable.worktoday')" min-width="250" prop="finish">

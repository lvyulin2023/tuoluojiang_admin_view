        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu style="text-align: center">
              ...
              <el-dropdown-item
                v-if="userInfo.id == scope.row.master_uid || userInfo.id == scope.row.del_user.id"
...
export default {
  ...
  methods: {
    ...
    dropdownFn() {
      ...
      this.$modalSure('确定批量恢复选中数据').then(() => {
    ...
    batchDeletFn() {
      ...
      this.$modalSure('确定批量删除选中数据').then(() => {

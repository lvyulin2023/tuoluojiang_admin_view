        ...
        <div class="flex" v-if="spaceId && breadcrumbArray.length != 0">
          ...
          <el-dropdown trigger="hover">
            <span class="el-dropdown-link">
              <i class="iconfont icongengduo2 fz30 pointer"></i>
            </span>
            <el-dropdown-menu slot="dropdown">
        ...
        <div class="flex" :class="breadcrumbArray.length > 0 ? 'mt8' : 'mt14'">
          ...
          <div class="mr10 icon-name" v-if="switchIndex !== 1">
            <div class="el-dropdown sort-dropdown display-align">
              <span @click.stop="handleSortShow" class="el-dropdown-link pointer el-dropdown-selfdefine text-16">
...
export default {
  ...
  methods: {
    ...
    handleSuccess(response) {
      ...
      this.$emit('formBoxClick', 'handleSuccess', response)
    },

    // 上传前
    handleUpload(file, item) {
      const types = helper.uploadTypes
      this.uploadData.pid = this.pid

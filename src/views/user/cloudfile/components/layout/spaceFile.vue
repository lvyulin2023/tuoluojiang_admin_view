                ...
                <li v-for="(item, index) in fileData" :key="index" :class="menuIds.includes(item.id) ? 'active' : ''">
                  <div class="content-left pointer">
                    ...
                    >
                      ...
                      <template v-if="fileStyle.style == 1 && item.type == 1">
                    ...
                    <div class="icon-star-right pointer">
                      ...
                      >
                        <div class="right-item-list">
                          ...
                          <div
                            v-if="item.type === 1 && item.user_id === $store.state.user.userInfo.id"
                            class="right-item"
...
<script>
import { folderSpaceEntDeleteApi, folderSpaceEntListApi, folderSpaceEntRenameApi } from '@/api/cloud'
...
export default {
  ...
  methods: {
    ...
    getTreeData(val) {
      ...
      folderSpaceEntListApi(this.spaceId, data).then((res) => {
    ...
    getMoveDialog(item, type) {
      ...
      this.moveData.fid = item.pid || this.spaceId

  ...
  <div class="divBox">
    <el-card class="employees-card-bottom">
      ...
      <div v-if="activeVal == 1" class="main">
        <div v-if="detailData.duty" class="detail-box">
          ...
          <div class="content" v-html="detailData.duty" />
        </div>
        <div v-else>
      ...
      <div v-if="activeVal == 2" class="table-box">
        ...
        <el-table :data="tableData" :height="tableHeight" style="width: 100%">
          ...
          <el-table-column :label="$t('toptable.department')" min-width="140" prop="frame.name">
          ...
          <el-table-column label="更新时间" prop="job.updated_at"> </el-table-column>
          <el-table-column fixed="right" label="操作" width="130">
            <template slot-scope="scope">
              <el-button size="small" type="text" @click="onCheck(scope.row)">查看</el-button>
              <el-button v-if="scope.row.operate" size="small" type="text" @click="onEdit(scope.row)">编辑</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-drawer :before-close="handleClose" :visible.sync="checkDrawer" direction="rtl" size="60%" title="岗位职责表">
      <div v-if="detailDataInfo" class="check-box">
        <div class="content mt14" v-html="detailDataInfo" />
      </div>
      <div v-else>
...
export default {
  name: 'Duty',
  components: { defaultPage, ueditorFrom },
  data() {
    return {
      activeVal: '1',
      loading: false,

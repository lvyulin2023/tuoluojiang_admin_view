          ...
          <li v-for="(item, index) in tableData" :key="index">
            <el-row class="table-header">
              ...
              <el-col :span="12" class="text-right">
                <el-button size="mini" v-hasPermi="['user:examine:approval:details']" @click="handleDetail(item)"
                  >查看详情</el-button
                >
                <template v-if="item.status == 0">
                  <el-button
                    v-if="item.verify_status === 0"
                    v-hasPermi="['user:examine:approval:refuse']"
                    type="danger"
                    size="mini"
                  ...
                  <el-button
                    v-if="item.verify_status === 0"
                    v-hasPermi="['user:examine:approval:agree']"
                    type="primary"
                    size="mini"

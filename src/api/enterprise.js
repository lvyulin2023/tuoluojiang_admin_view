...
export function trendStatisticsApi(data) {
  return request.get(`client/customer/trend_statistics`, data)
}
...
export function billChangeBie(data) {
  return request.get(`bill/rank_analysis`, data)
}
...
export function assessCensusApi(data) {
  return request.get(`assess/census_bar`, data)
}
 ...
 */
export function assessCensusLineApi(data) {
  return request.get(`assess/census`, data)
}
...
export function clientContractListApi(data) {
  return request.get(`client/contracts`, data)
}
...
export function clientContractShiftApi(data) {
  return request.put(`client/contracts/shift`, data)
}
...
export function salesmanDataListApi(data) {
  return request.get(`client/customer/ranking`, data)
}
...
export function performanceStatisticsApi(data) {
  return request.get(`client/customer/statistics`, data)
}
